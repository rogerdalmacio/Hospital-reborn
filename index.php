                            ...
                            <div class="card mb-3" style="border: none;">
                                ...
                                <div class="card-body" id="card-body" style="background: #fff; color: #000000;">
                                   ...
                                   <form action="controllers/LoginController.php" method="post">
                                               ...
                                               <input type="text" name="username" placeholder="email" class="form-control" id="floatingInput" style="border-top: none; border-left: none; border-right: none; border-bottom: 1px solid #000 !important; box-shadow: none !important;" required><br>
