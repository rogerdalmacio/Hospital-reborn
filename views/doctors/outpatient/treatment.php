...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Outpatient</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content" data-bs-parent="#sidebar-nav">
            <li>
                <a href="treatment.php" class="active">
                <i class="bi bi-circle"></i><span>Outpatient Treatment</span>
                </a>
            </li>
        </li>
        </ul>
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Outpatient treatment</li>
          </ol>
        </nav>
      </div><!-- End Page Title -->
...
<body>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <select class="form-select" aria-label="Default select example" id="outpatient_type">
          <option selected disabled value="">Select Outpatient type</option>
    ...
    <form id="outpatient_form" action="submit_outpatient_treatment.php" method="post">
      <div id="outpatient_with_records" style="display:none">
        <h1>Outpatient With Records</h1>
        <div class="row mb-3">
            <label for="inputText" class="col-sm-2 col-form-label">Patient ID</label>
            <div class="col-sm-10">
              <input type="hidden" value="1" name="outpatient_type">
              <input id="search_patient" type="text" class="form-control">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">search result:</p>
                  <!-- Default List group -->
