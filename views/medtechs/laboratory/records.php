<?php 
    ...
    $listOfLaboraties = $query->listOfLaboratories('released');
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
          <a class="nav-link" data-bs-target="#lab-nav" data-bs-toggle="collapse" href="#">
          ...
          <ul id="lab-nav" class="nav-content" data-bs-parent="#sidebar-nav">
            <li>
              <a class="collapsed" href="release.php">
                <i class="bi bi-circle"></i><span>Release result</span>
              </a>
            </li>
            <li>
              <a class="nav-link active" href="released.php">
                <i class="bi bi-grid"></i>
          ...
          <form action="">
            <div class="modal-body">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <textarea id="release_modal_test_result" class="form-control" style="height: 100px" name="breakfast"></textarea>
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputPassword" class="col-sm-3 col-form-label">Comments</label>
                <div class="col-sm-9">
                  <textarea id="release_modal_comments" class="form-control" style="height: 100px" name="breakfast"></textarea>
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputText" class="col-sm-3 col-form-label">Examined by</label>
                <div class="col-sm-9">
                  <input id="release_modal_examined_by" type="text" class="form-control">
                </div>
              </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button id="print-btn" type="button" class="btn btn-primary">Save</button>
            </div>
          </form>
        </div>
      </div>
    ...
    <script>
      $(document).ready(function() {
            ...
            columns: [
                ...
                { data: 'examine_date' },
                {
                  ...
                  render: function(data, type, row) {
                        return '<button type="submit" class="btn btn-outline-secondary btn-sm m-1" data-bs-toggle="modal" data-bs-target="#verticalycentered" data-id="' + row.id +'">Edit</button>';
                }
              }
            ]
        });
        ...
        $('#laboratory_result tbody').on('click', 'tr', function () {
            ...
            $('#release_modal_test_name').val(data.test_name)
            $('#release_modal_first_name').val(data.first_name)
            $('#release_modal_last_name').val(data.last_name)
            $('#release_modal_test_result').val(data.test_result)
            $('#release_modal_comments').val(data.comments)
            $('#release_modal_examined_by').val(data.examined_by)
